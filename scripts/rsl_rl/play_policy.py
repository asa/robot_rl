...
SIM_ENVIRONMENTS = {
    ...
    "lpa_walking_clf_cladwalkgaitprogstop": "LPA-walking-clf-cladwalkgaitprogstop",  # rung 2: stop/start
    "lpa_walking_clf_cladwalkgaitprogyaw": "LPA-walking-clf-cladwalkgaitprogyaw",  # rung 1: yaw
    "lpa_walking_clf_cladwalkgaitprog": "LPA-walking-clf-cladwalkgaitprog",  # progress at ref speed
    "lpa_walking_clf_cladstomp0": "LPA-walking-clf-cladstomp0",  # from-scratch stomp control
    "lpa_walking_clf_cladwalkgaitvel": "LPA-walking-clf-cladwalkgaitvel",  # base speed profile x8
    ...
    "lpa_walking_clf_cladwalk3": "LPA-walking-clf-cladwalk3",  # low entropy
    "lpa_walking_clf_cladwalk2": "LPA-walking-clf-cladwalk2",  # solved arms
    "lpa_walking_clf_cladwalk": "LPA-walking-clf-cladwalk",  # walk baseline
    "lpa_walking_clf_clad4": "LPA-walking-clf-clad4",  # walking-only cmds
    "lpa_walking_clf_clad3": "LPA-walking-clf-clad3",  # clad + turns + arms
    "lpa_walking_clf_clad2": "LPA-walking-clf-clad2",  # clad + turns
    "lpa_walking_clf_clad1": "LPA-walking-clf-clad1",  # clad library
